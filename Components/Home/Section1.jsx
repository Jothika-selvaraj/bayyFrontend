  ...
  const courses = [
    {
      ...
      img: "/assets/Course/Tajweed.png", // Updated for Next.js public path
    ...
    },
    {
      id: 2,
      price: "Quran Hifz",
      img: "/assets/Course/Islamic course.png", // Updated for Next.js public pathany
      title: "Quran Hifz",
    ...
    },
    {
      ...
      img: "/assets/Course/Arabic language.png", // Updated for Next.js public path
