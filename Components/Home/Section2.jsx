      ...
      <div className="container mx-auto flex flex-col lg:flex-row items-center gap-8">
        ...
        <div className="lg:w-1/2 relative px-6">
          <div className="rounded-3xl overflow-hidden shadow-lg">
            <Image
              src="/assets/Header/why.jpeg" // Image source
          ...
          {/* Caption Card */}
          <div className="absolute bottom-4 right-40 transform translate-x-1/2 translate-y-1/2 bg-blue-gray-50 text-gray-800 px-8 py-5 rounded-lg shadow-lg w-[50%]">
            ...
            <div className="flex items-center space-x-3">
              ...
              <Image
                src="/assets/Common/instructor-1.jpg" // Profile image source
                alt="Profile"
